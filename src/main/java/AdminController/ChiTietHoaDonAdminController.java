...
@WebServlet("/chiTietHoaDonAdminController")
public class ChiTietHoaDonAdminController extends HttpServlet {

	private static final long serialVerionUID = 1L;

	public ChiTietHoaDonAdminController() {
		super();
		 ...
		 try {
			 HttpSession session = req.getSession();
		        ...
		        if (hoadon == null) {
		            ...
		            resp.sendRedirect("hoaDonAdminController");
		            return;
		        }
		        ChiTietHoaDonBo cthdbo = new ChiTietHoaDonBo();
		        req.setAttribute("hoadon", hoadon);
		        req.setAttribute("dsChiTiet", cthdbo.layChiTietHoaDon(mahoadon));
		        req.getRequestDispatcher("TrangChiTietHoaDonAdmin.jsp").forward(req, resp);
