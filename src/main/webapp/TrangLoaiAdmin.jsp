                ...
                <table
                    ...
                    <thead>
                        <tr style="background-color: #333; color: white;">
                            ...
                            <th style="padding: 12px; text-align: left;">Tên loại bánh</th>
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom: 1px solid #ddd;">
                            ...
                            <td style="padding: 12px;"><%=l.getTenloai()%></td>
                            <td style="padding: 12px; text-align: center;">
                                <a href="suaLoaiBanhController?maloai=<%=l.getMaloai()%>"
                                    style="padding: 5px 10px; background-color: #2196F3; color: white; text-decoration: none; border-radius: 3px; margin-right: 5px;">Sửa</a>
                                <a href="xoaLoaiBanhController?maloai=<%=l.getMaloai()%>"
                                    onclick="return confirm('Bạn có chắc muốn xóa loại bánh này?')"
