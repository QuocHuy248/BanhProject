...
<body class="bg-light">
	...
	<div class="container my-5">
		...
		<%
		ArrayList<HoaDon> dsHoaDon = (ArrayList<HoaDon>) request.getAttribute("hoadonlist");
		if (dsHoaDon == null || dsHoaDon.isEmpty()) {
		%>
		<div class="text-center">
			<p>Bạn chưa có đơn hàng nào</p>
			<a href="banhUserController" class="btn btn-primary"> <i
				class="fas fa-shopping-basket"></i> Mua hàng ngay
			</a>
		</div>
		<%
		} else {
 ...
 %>
						...
						<td class="text-center"><a
							href="chiTietHoaDonUserController?mahoadon=<%=hd.getMahoadon()%>"
