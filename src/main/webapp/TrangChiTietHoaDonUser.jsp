    ...
    <div class="container my-5">
        ...
        <div class="order-info">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <span class="status-badge <%= hoaDon.isDamua() ? "bg-success" : "bg-warning text-dark" %>">
            ...
            <div class="row">
                <div class="col-md-6">
                    <p><strong><i class="far fa-calendar-alt"></i> Ngày đặt:</strong> 
                        <%= sdf.format(hoaDon.getNgaymua()) %>
                    </p>
                    <p><strong><i class="far fa-user"></i> Mã khách hàng:</strong> 
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            for(ChiTietHoaDon ct : dsChiTiet) { 
                                long thanhTien = ct.getGia() * ct.getSoluong();
                                tongTien += thanhTien;
                            %>
                            <tr>
                                <td>
        ...
        <div class="d-flex justify-content-between mt-4">
            ...
            <% if(!hoaDon.isDamua()) { %>
                <button class="btn btn-primary" onclick="confirmPayment(<%= hoaDon.getMahoadon() %>)">
